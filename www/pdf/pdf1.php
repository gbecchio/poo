...
class MC_TCPDF extends TCPDF
{
    ...
    public function Footer() {
        ...
        $this->Cell(0,0,"toto", 0, false, 'L', 0, '', 0, false, 'T', 'M');
        // Page number
...
// print TEXT
$pdf->PrintChapter(1, 'LOREM IPSUM [TEXT]', 'chapter_demo_1.txt', false);

// print HTML
$pdf->PrintChapter(2, 'LOREM IPSUM [HTML]', 'chapter_demo_2.txt', true);
