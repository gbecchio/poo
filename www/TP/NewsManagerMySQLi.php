...
class NewsManagerMySQLi extends NewsManager
{
    ...
    */
    ...
    {
        $requete = $this->db->prepare('INSERT INTO news2 SET auteur = ?, titre = ?, contenu = ?, dateAjout = NOW(), dateModif = NOW()');
    ...
    */
    ...
    {
        return $this->db->query('SELECT id FROM news2')->num_rows;
    }
    ...
    */
    public function delete($id)
    {
        ...
        $requete = $this->db->prepare('DELETE FROM news2 WHERE id = ?');
    ...
    */
    public function getUnique($id)
    {
        ...
        $requete = $this->db->prepare('SELECT id, auteur, titre, contenu, dateAjout, dateModif FROM news2 WHERE id = ?');
        $requete->bind_param('i', $id);
        $requete->execute();
    ...
    */
    ...
    {
        $requete = $this->db->prepare('UPDATE news2 SET auteur = ?, titre = ?, contenu = ?, dateModif = NOW() WHERE id = ?');
